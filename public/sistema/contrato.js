$(document).ready(function(){
		...
		// Validação Formulario Criar Contrato
...
*		VISUALIZA CONTRATO
*----------------------------------------------
* pega o id fo botão visualizar e manda uma
* requisição para a rota /admin/contrato/ via "GET"
...
*
*----------------------------------------------
*		EDITA CONTRATO ( VISUALIZAÇÃO )
*----------------------------------------------
* pega o id do botão editar e manda uma requisição
* para a rota /admin/contrato/editar retorna os
* dados
*
*/
